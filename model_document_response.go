...
func NewDocumentResponse(data DocumentOut) *DocumentResponse {
...
func (o *DocumentResponse) GetData() DocumentOut {
	if o == nil {
		var ret DocumentOut
		return ret
	}
...
func (o *DocumentResponse) GetDataOk() (*DocumentOut, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *DocumentResponse) SetData(v DocumentOut) {
	o.Data = v
}
