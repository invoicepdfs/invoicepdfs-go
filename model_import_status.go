...
// ImportStatus How far an import has got.  `confirm_import` completes the work before it responds, so an import is `pending` until it is confirmed and `completed` immediately afterwards.
