...
type _BusinessProfileResponse BusinessProfileResponse

// NewBusinessProfileResponse instantiates a new BusinessProfileResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewBusinessProfileResponse(data BusinessProfileOut) *BusinessProfileResponse {
...
func (o *BusinessProfileResponse) GetData() BusinessProfileOut {
	if o == nil {
...
func (o *BusinessProfileResponse) GetDataOk() (*BusinessProfileOut, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *BusinessProfileResponse) SetData(v BusinessProfileOut) {
	o.Data = v
}
...
func (o *BusinessProfileResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varBusinessProfileResponse := _BusinessProfileResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBusinessProfileResponse)

	if err != nil {
		return err
	}

	*o = BusinessProfileResponse(varBusinessProfileResponse)
