...
`func (o *LineItemTaxInput) GetCategory() TaxCategory`

GetCategory returns the Category field if non-nil, zero value otherwise.

### GetCategoryOk

`func (o *LineItemTaxInput) GetCategoryOk() (*TaxCategory, bool)`
...
`func (o *LineItemTaxInput) SetCategory(v TaxCategory)`

SetCategory sets Category field to given value.

### HasCategory

`func (o *LineItemTaxInput) HasCategory() bool`

HasCategory returns a boolean if a field has been set.

### SetCategoryNil

`func (o *LineItemTaxInput) SetCategoryNil(b bool)`

 SetCategoryNil sets the value for Category to be an explicit nil

### UnsetCategory
`func (o *LineItemTaxInput) UnsetCategory()`
