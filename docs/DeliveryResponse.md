...
`func NewDeliveryResponse(data DeliveryOut, ) *DeliveryResponse`
...
`func (o *DeliveryResponse) GetData() DeliveryOut`

GetData returns the Data field if non-nil, zero value otherwise.

### GetDataOk

`func (o *DeliveryResponse) GetDataOk() (*DeliveryOut, bool)`
...
`func (o *DeliveryResponse) SetData(v DeliveryOut)`
