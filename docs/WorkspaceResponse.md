...
`func NewWorkspaceResponse(data WorkspaceOut, ) *WorkspaceResponse`
...
`func (o *WorkspaceResponse) GetData() WorkspaceOut`

GetData returns the Data field if non-nil, zero value otherwise.

### GetDataOk

`func (o *WorkspaceResponse) GetDataOk() (*WorkspaceOut, bool)`
...
`func (o *WorkspaceResponse) SetData(v WorkspaceOut)`
