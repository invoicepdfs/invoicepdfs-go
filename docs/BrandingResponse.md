...
`func NewBrandingResponse(data BrandingOut, ) *BrandingResponse`
...
`func (o *BrandingResponse) GetData() BrandingOut`

GetData returns the Data field if non-nil, zero value otherwise.

### GetDataOk

`func (o *BrandingResponse) GetDataOk() (*BrandingOut, bool)`
...
`func (o *BrandingResponse) SetData(v BrandingOut)`
