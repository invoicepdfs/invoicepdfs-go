...
`func (o *DocumentPatchRequest) GetBuyerReference() string`

GetBuyerReference returns the BuyerReference field if non-nil, zero value otherwise.

### GetBuyerReferenceOk

`func (o *DocumentPatchRequest) GetBuyerReferenceOk() (*string, bool)`
...
`func (o *DocumentPatchRequest) SetTaxSchemeNil(b bool)`
...
`func (o *DocumentPatchRequest) SetDeliveryDateNil(b bool)`
