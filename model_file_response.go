...
func NewFileResponse(data FileOut) *FileResponse {
	this := FileResponse{}
	this.Data = data
	return &this
}
...
func (o *FileResponse) GetData() FileOut {
	if o == nil {
		var ret FileOut
		return ret
	}
...
func (o *FileResponse) GetDataOk() (*FileOut, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *FileResponse) SetData(v FileOut) {
	o.Data = v
}
